...
\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \node[text=secondaryColor, font=\large\bfseries, anchor=north west, text width=\availableWidth] at (0.5cm,-1.9cm) {\color{accentColor}JavaScript Promises: \color{primaryColor}Part 1: Fundamentals};
