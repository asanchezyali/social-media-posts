...
body + callouts are **ragged-right** (`\RaggedRight` + `\emergencystretch=4em`) — justifying
this narrow measure with inline `\code{}` chips makes ugly rivers; and run the prose
through the humanize-writing-en pass, especially **thinning em-dashes** (they pile up fast)),
