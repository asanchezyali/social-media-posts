    ...
    \put(0,0){%
        \begin{tikzpicture}[remember picture, overlay]
            ...
            \node[inner sep=0pt] at (current page.center) {
                \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{slides/Futuristic Cybersecurity Analyst.jpeg}
            };
...
{\centering
\includegraphics[width=0.85\textwidth]{slides/latency_results.png}\par
}
