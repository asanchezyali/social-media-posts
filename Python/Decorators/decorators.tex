    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node[text width=14cm, align=center] at (0,0) {
                {\fontsize{48}{52}\bfseries\color{primaryColor}Decorators: \color{accentColor}Transform Your Code\par}
            };
            ...
            \node[text width=14cm, align=center] at (0,-4) {
                {\fontsize{22}{26}\color{secondaryColor}How will you leverage decorators in your next project?\par}
            };
        \end{tikzpicture}
    \end{center}
}
